...
class C2 extends Component
{
    ...
    {
        console.log(" I am shouldcomponent update method");
        return true ;
    }
    getSnapshotBeforeUpdate()
    {
        console.log("I am get component snapshotbefore update");
        return null;
    }
    componentDidUpdate()
    {
    ...
    render()
    {
        ...
        return(
            <div>
                ...
                <button onClick={()=>{this.setState({role:"Doctor"})}}>button</button>
                {
